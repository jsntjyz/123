...
#sys.path.append("/home/lenovo/catkin_ws_arenarosnav/src/arena-rosnav/task_generator") 

from stable_baselines3 import PPO
from stable_baselines3.common.vec_env import SubprocVecEnv, DummyVecEnv, VecNormalize
from stable_baselines3.common.monitor import Monitor
from stable_baselines3.common.evaluation import evaluate_policy
#from rl_utils.envs.flatland_gym_env import FlatlandEnv
...
def get_paths(args: dict, AGENT: str):
    ...
    PATHS = {
        ...
        "robot_setting": os.path.join(
            rospkg.RosPack().get_path("arena-simulation-setup"), f"{robot_model}.model.yaml"
        ),
